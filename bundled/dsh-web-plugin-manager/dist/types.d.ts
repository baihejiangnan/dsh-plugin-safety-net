...
export interface CommandResult {
    ...
    readonly awaiting?: {
        ...
        readonly questions: readonly EnvQuestion[];
    };
}
...
export interface AnalyzeIssue {
    readonly kind: 'missing-import' | 'disabled-dependency' | 'circular-dependency' | 'duplicate-row-id' | 'peer-mismatch' | 'service-conflict' | 'tool-conflict' | 'section-conflict' | 'route-conflict' | 'official-duplicate' | 'pending-dependency' | 'load-failure';
    readonly message: string;
    readonly from?: string;
    readonly to?: string;
