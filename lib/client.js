...
// Aggregate client entry: DSH activates this package id, then delegates the
// browser-side settings sections to the bundled child modules.
window.__ModuleLoader__.load({
  id: "dsh-plugin-safety-net",
  factory: function (require) {
    var module = { exports: {} };
    var guard = require("dsh-plugin-guard");
    var manager = require("dsh-web-plugin-manager");
    var healthcheck = require("dsh-plugin-healthcheck");
    module.exports.apply = function (ctx) {
      guard.apply(ctx);
      manager.apply(ctx);
      healthcheck.apply(ctx);
    };
    module.exports.inject = ["slots", "settingsScope", "locale"];
    return module.exports;
  }
});
